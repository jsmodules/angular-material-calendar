...
angular.module("materialCalendar").directive("calendarMd", ["$compile", "$parse", "$templateRequest", "$q", "materialCalendar.Calendar", "MaterialCalendarData", function ($compile, $parse, $templateRequest, $q, Calendar, CalendarData) {
    ...
    return {
        ...
        link: function ($scope, $element, $attrs) {
            ...
            var handleCb = function (cb, data, $event) {
            ...
            $scope.prev = function () {
                ...
                setData();
                handleCb($scope.onPrevMonth, data, null);
            };
            ...
            $scope.next = function () {
                ...
                setData();
                handleCb($scope.onNextMonth, data, null);
            };

            $scope.handleDayClick = function (date, $event) {
                ...
                handleCb($scope.onDayClick, angular.copy(date), $event);
